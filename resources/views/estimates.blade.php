@extends('layouts.app')
@section('title', 'Contractor Los Angeles - Estimates')
@section('description', 'Company Name - Estimates')
@section('keyword', 'Estimates')
...
<section id="blog">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="blog-header-title">Estimates</h2>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
